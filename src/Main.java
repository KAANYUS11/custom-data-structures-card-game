 ...
 * 
 * @author Kaan Uz (replace with your name)
 */
...
public class Main {
    public static void main(String[] args) {
        System.out.println("Main start - args length: " + args.length);
            ...
            while (reader.hasNext()) {
                ...
                switch (command) {
                    case "draw_card": {
                        ...
                        if (scanner.hasNext())
                            hp = scanner.nextInt();
                        out = game.drawCard(name, att, hp); // suggested method for draw_card command
                        break;
                    }
                    case "battle": {
                        int att = 0;
                    ...
                    case "steal_card": {
                        ...
                        if (scanner.hasNext())
                            hp = scanner.nextInt();
                        out = game.stealCard(att, hp); // suggested method for steal_card command
                        break;
                    }
                    default: {
